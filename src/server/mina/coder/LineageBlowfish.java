...
public class LineageBlowfish {
	...
	private int[] P = { 0x243F6A88, 0x85A308D3, 0x13198A2E, 0x3707344,
	...
	public long[] blowfish_init(long[] keys) {
		int i = 0;
		int j = 0;
	...
	public void blowfish_encrypt(long L, long R) {
		long temp, xL = L, xR = R;
		...
		for (int i = 0; i < 16; i++) {
			...
			xR ^= blowfish_F(ul32.fromLong64(xL));
	...
	public long[] getSeeds(long[] keys) {
		blowfish_init(keys);

		long rotrParam = ul32.fromLong64(keys[0] ^ 0x9C30D539);
		keys[0] = ul32.fromLong64(_rotr((int) rotrParam, 13));

		keys[1] = (keys[1] ^ keys[0] ^ 0x7C72E993);
		return keys;
	}

	public int _rotr(int value, int n) {
