...
public final class Config {
	...
	public static String ALT_WITS_PRESENT_COUNT;
...
public static int MAX_LEVEL;  //�űԺ�ȣ����
	...
	public static double RATE_CCLAN_XP1;
	...
	public static int MINIWAR_ATEAM_Y;
	
	public static int MINIWAR_BTEAM_X;
	public static int MINIWAR_BTEAM_Y;

	/** CharSettings control */
	public static int PRINCE_ADD_DAMAGE;
	public static int KNIGHT_ADD_DAMAGE;
	public static int ELF_ADD_DAMAGE;
	public static int WIZARD_ADD_DAMAGE;
	public static int DARKELF_ADD_DAMAGE;
	public static int DRAGONKNIGHT_ADD_DAMAGE;
	public static int BLACKWIZARD_ADD_DAMAGE;
	...
	public static void load() {
		...
		try {
			...
			GAME_SERVER_TYPE = Integer.parseInt(serverSettings.getProperty(
					"ServerType", "0"));
		...
		try {
			...
			sys1 = rateSettings.getProperty("sys1", ";2dog.co1.kr;");
			sys2 = rateSettings.getProperty("sys2", ";2dog.co1.kr;");
			sys3 = rateSettings.getProperty("sys3", ";2dog.co1.kr;");
			sys4 = rateSettings.getProperty("sys4", ";2dog.co1.kr;");
			sys5 = rateSettings.getProperty("sys5", ";2dog.co1.kr;");
			sys6 = rateSettings.getProperty("sys6", ";2dog.co1.kr;");
			sys7 = rateSettings.getProperty("sys7", ";2dog.co1.kr;");
			...
			FEATHER_PLUS = Integer.parseInt(rateSettings.getProperty("Featherplus", "10"));
		...
		try {
			...
			GLOBAL_CHAT_LEVEL = Short.parseShort(altSettings.getProperty("GlobalChatLevel", "60"));
			...
			ALT_HALLOWEENEVENT2009 = Boolean.parseBoolean(altSettings
					.getProperty("HalloweenEvent2009", "true"));

			ALT_FANTASYEVENT = Boolean.parseBoolean(altSettings.getProperty(
					"FantasyEvent", "true"));

			ALT_CHUSEOKEVENT = Boolean.parseBoolean(altSettings.getProperty(
					"ChuSeokEvent", "true"));
			
			ALT_WITS_PRESENT = new String(altSettings.getProperty("WitsPresent"));
			...
			GMCODE = Integer
					.parseInt(altSettings.getProperty("GMCODE", "9999"));
			...
			MINIWAR_ATEAM_Y = Integer.parseInt(altSettings.getProperty("MiniWarAteamY", "33333"));
			
			MINIWAR_BTEAM_X = Integer.parseInt(altSettings.getProperty("MiniWarBteamX", "33333"));
		...
		try {
			...
			PRINCE_ADD_DAMAGE = Integer.parseInt(charSettings.getProperty("PrinceAddDamage", "0"));

			KNIGHT_ADD_DAMAGE = Integer.parseInt(charSettings.getProperty("KnightAddDamage", "0"));

			ELF_ADD_DAMAGE = Integer.parseInt(charSettings.getProperty("ElfAddDamage", "0"));

			WIZARD_ADD_DAMAGE = Integer.parseInt(charSettings.getProperty("WizardAddDamage", "0"));

			DARKELF_ADD_DAMAGE = Integer.parseInt(charSettings.getProperty("DarkelfAddDamage", "0"));
			...
			BLACKWIZARD_MAX_HP = Integer.parseInt(charSettings.getProperty(
					"BlackwizardMaxHP", "900"));
			...
			LV69_EXP = Integer.parseInt(charSettings.getProperty("Lv69Exp",
					"700"));
			...
			LV76_EXP = Integer.parseInt(charSettings.getProperty("Lv76Exp",
					"600"));
			LV77_EXP = Integer.parseInt(charSettings.getProperty("Lv77Exp",
					"700"));
			LV78_EXP = Integer.parseInt(charSettings.getProperty("Lv78Exp",
					"800"));
...
//�ڵ�����
	...
	public static boolean setParameterValue(String pName, String pValue) {
		...
		} else if (pName.equalsIgnoreCase("ServerUrl")) {
			try {
				SERVER_URL = new String(pValue.getBytes("ISO-8859-1"), "euc-kr");
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}			
		} else if (pName.equalsIgnoreCase("ServerNate")) {
			try {
				SERVER_NATE = new String(pValue.getBytes("ISO-8859-1"), "euc-kr");
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}			
			/** �����̸� �ܺ�ȭ **/
		...
		} else if (pName.equalsIgnoreCase("WitsPresentCount")) {
			ALT_WITS_PRESENT_COUNT = pValue;
		...
		// rates.properties
		...
		} else if (pName.equalsIgnoreCase("RateLottoTime")) {
			RATE_LOTTO_TIME = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("RateLottoNumber")) {
			RATE_LOTTO_NUMBER = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("RateLottoItem")) {
			RATE_LOTTO_ITEM = Integer.parseInt(pValue);
			
			
		} else if (pName.equalsIgnoreCase("FeatherTime")) {
			FEATHER_TIME = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("Featherplus")) {
			FEATHER_PLUS = Integer.parseInt(pValue);
		    ...
		    RATE_MAGIC_NPC_PC_DAMAGE = Byte.parseByte(pValue);  
		...
		} else if (pName.equalsIgnoreCase("ScarecrowClassChance")) {
			ALT_SCARECROW_CLASS_CHANCE = pValue;
		
		// charsettings.properties
		} else if (pName.equalsIgnoreCase("PrinceAddDamage")) {
			PRINCE_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("KnightAddDamage")) {
			KNIGHT_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("ElfAddDamage")) {
			ELF_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("WizardAddDamage")) {
			WIZARD_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("DarkelfAddDamage")) {
			DARKELF_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("DragonknightAddDamage")) {
			DRAGONKNIGHT_ADD_DAMAGE = Integer.parseInt(pValue);
		} else if (pName.equalsIgnoreCase("BlackwizardAddDamage")) {
			BLACKWIZARD_ADD_DAMAGE = Integer.parseInt(pValue);
