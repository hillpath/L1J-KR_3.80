	...
	public S_ShopSellList(int objId) {
		...
		for (int i = 0; i < shopItems.size(); i++) {
			...
			if (!(npcId == 70035 || npcId == 70041 || npcId == 70042
					|| npcId == 777835 || npcId == 877831 || npcId == 877832
					|| npcId == 877833 || npcId == 877834 || npcId == 877835
					|| npcId == 877836 || npcId == 877837 || npcId == 877838)) {
			...
			if (shopItem.getPackCount() > 1) {
				...
				if (shopItem.getEnchant() > 0) {
					writeS("+" + shopItem.getEnchant() + " " + item.getNameId());	 
				} else {
