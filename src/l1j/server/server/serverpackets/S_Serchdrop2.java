	...
	private void buildPacket(int npcid) {
		...
		try {
			...
			writeS("\r검색할 몹 : "
					...
					+ itemname[3] + " | " + itemname[4] + " | " + itemname[5]
					+ " | " + itemname[6] + " | " + itemname[7] + " | "
					+ itemname[8] + " | " + itemname[9] + " | " + itemname[10]
					+ " | " + itemname[11] + " | " + itemname[12] + " | "
					+ itemname[13] + " | " + itemname[14] + " | "
					+ itemname[15] + " | " + itemname[16] + " | "
					+ itemname[17] + " | " + itemname[18] + " | "
					+ itemname[19] + " | " + itemname[20] + " | "
					+ itemname[21] + " | " + itemname[22] + " | "
					+ itemname[23] + " | " + itemname[24] + " | "
					+ itemname[25] + " | " + itemname[26] + " | "
					+ itemname[27] + " | " + itemname[28] + " | "
					+ itemname[29]);
