...
case 0x68:
	 ...
	 * packetbox :119 길이 :48
	 * ================================================================================
	 * 77 68 01 (옵/타입/사람수-초대파티원제외한사람수) e4 eb 26 0f / 45 76 61 74 65 73 74 00 /
	 * 64 / 44 00 00 00 / 1a 80 / ef 7f (obj/name/게이지/map/x/y) b4 45 26 0f / 45
	 * 76 61 74 65 73 74 31 31 00 / 64 / 44 00 00 00 / 19 80 / ef 7f
	 * (obj/name/게이지/map/x/y) 3c
	 */
	 ...
	 * packetbox :119 길이 :24
	 * ================================================================================
	 * 77 / 69 (옵/타입) b4 45 26 0f / 45 76 61 74 65 73 74 31 31 00 / 44 00 00 00 /
	 * 19 80 / ef 7f (obj/name/map/x/y)
	 */
	 ...
	 * packetbox :119 길이 :8
	 * ================================================================================
	 * 77 6a (옵/타입) b4 45 26 0f (파티장 받는 objid) dd 03
	 */
	 ...
	 * packetbox :119 길이 :40
	 * ================================================================================
	 * 77 6e 03 (옵/타입/파티원사람수) 8c d3 25 0f / 44 00 00 00 / 19 80 / f0 7f
	 * (obj/map/x/y) b4 45 26 0f / 44 00 00 00 / 19 80 / ef 7f (obj/map/x/y) e4
	 * eb 26 0f / 44 00 00 00 / 1a 80 / ef 7f (obj/map/x/y) 2e
	 */
