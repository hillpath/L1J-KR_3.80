...
public class L1ClanMatching {
	...
	public static L1ClanMatching getInstance() {
		if (_instance == null) { _instance = new L1ClanMatching(); }
		return _instance;
	}
	...
	private FastTable<ClanMatchingList> _list = new FastTable<ClanMatchingList>();
	...
	public FastTable<ClanMatchingList> getMatchingList() {
		return _list;
	}
