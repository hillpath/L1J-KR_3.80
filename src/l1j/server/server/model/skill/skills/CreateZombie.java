...
public class CreateZombie {
	public static void runSkill(L1PcInstance _user, L1PcInstance _player,
			L1Character _target, L1NpcInstance _targetNpc) {
		int petcost = 0;
		...
		charisma -= petcost;
		if (charisma >= 6) {
			L1SummonInstance summon = new L1SummonInstance(_targetNpc, _user,
					true);
			_target = summon;
		} else {
