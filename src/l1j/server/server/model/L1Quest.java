...
public class L1Quest {
	...
	public static final int QUEST_LEVEL55 = 6;

	public static final int QUEST_LEVEL60 = 7;

	public static final int QUEST_LEVEL70 = 5;

	public static final int QUEST_LEVEL65 = 8;

	public static final int QUEST_LEVEL75 = 9;
	...
	public static final int QUEST_VETERAN = 43; //베테르랑
	public static final int QUEST_ICEQUEEN = 55; //이건모지
	...
	public int get_step(int quest_id) {
		...
		if (_quest == null) {
			...
			try {
				...
				_log.log(Level.SEVERE, "L1Quest[]Error", e);
			} finally {
				SQLUtil.close(rs);
				SQLUtil.close(pstm);
				SQLUtil.close(con);
	...
	public void set_step(int quest_id, int step) {
		...
		try {
			...
			_log.log(Level.SEVERE, "L1Quest[]Error1", e);
