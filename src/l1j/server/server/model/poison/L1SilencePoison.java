...
public class L1SilencePoison extends L1Poison {
	...
	private void doInfection() {
		...
		_target.getSkillEffectTimerSet().setSkillEffect(L1SkillId.STATUS_POISON_SILENCE, 0);
	}
	...
	public void cure() {
		...
		_target.getSkillEffectTimerSet().killSkillEffectTimer(L1SkillId.STATUS_POISON_SILENCE);
