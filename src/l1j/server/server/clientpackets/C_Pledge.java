	...
	public C_Pledge(byte abyte0[], LineageClient clientthread) {
		...
		if (pc.getClanid() > 0) {
			...
			//	}
				...
				//Å¬·£Á¤º¸Ã¢
				String[] Pledge = new String[] { 
				clan.getClanName(), String.valueOf(clan.getClanBirthDay()), clan.getOnlineMembersFP() };
				pc.sendPackets(new S_NPCTalkReturn(pc.getId(), "pledge", Pledge));
			}
		} else {
