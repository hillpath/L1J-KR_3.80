...
public class GeneralThreadPool {
	...
	// 일단 L1J 디폴트 상태로, map:4에 있는 아무것도 하고 있지 않는 PC가 1초간에 점유 하는 실행 시간은 약 6ms(AutoUpdate: 약 6ms, ExpMonitor:극소)
	private final int _pcSchedulerPoolSize = 1 + Config.MAX_ONLINE_USERS / 20; // 적당(20 User에 1개정도의 할당)
	...
	public final class CRejectedExecutionHandler implements
