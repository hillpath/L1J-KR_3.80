...
public class LetterTable {
	...
	public int getLetterCount(String name, int type) {
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error", e);
		} finally {
			SQLUtil.close(rs);
			SQLUtil.close(pstm);
			SQLUtil.close(con);
	...
	public void writeLetter(int code, String dTime, String sender,
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error1", e);
		} finally {
			SQLUtil.close(rs);
			SQLUtil.close(pstm1);
			SQLUtil.close(pstm2);
	...
	public void writeLetter(int itemObjectId, int code, String sender,
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error2", e);
		} finally {
			SQLUtil.close(rs);
			SQLUtil.close(pstm1);
			SQLUtil.close(pstm2);
	...
	public void deleteLetter(int itemObjectId) {
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error3", e);
		} finally {
			SQLUtil.close(pstm);
			SQLUtil.close(con);
		}
	...
	public void SaveLetter(int id, int letterType) {
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error4", e);
		} finally {
			SQLUtil.close(pstm);
			SQLUtil.close(con);
		}
	...
	public void CheckLetter(int id) {
		...
		try {
			...
			_log.log(Level.SEVERE, "LetterTable[]Error5", e);
		} finally {
			SQLUtil.close(pstm);
			SQLUtil.close(con);
		}
