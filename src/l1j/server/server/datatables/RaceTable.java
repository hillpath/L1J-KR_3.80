...
public class RaceTable {
	...
	private FastMap<Integer, L1Racer> _namelist;
	...
	public RaceTable() {
		_namelist = new FastMap<Integer, L1Racer>();
		bnl();
	}
	...
	private void BadnameTable(ResultSet Data) throws Exception {
		...
		// Data.close();
		// System.out.println("[::::::] util_racer: "+_namelist.size()+"개의 정보가
		// 로드되었습니다.");
		// eros.tarea.append("\n[::::::] util_racer: "+_namelist.size()+"개의 정보가
		// 로드되었습니다.");
	}
