...
public class NpcSpawnTable {
	...
	private void fillNpcSpawnTable() {
		...
		try {
			...
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error", e);
		} catch (SecurityException e) {
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error1", e);
		} catch (ClassNotFoundException e) {
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error2", e);
		} finally {
			SQLUtil.close(rs);
			SQLUtil.close(pstm);
			SQLUtil.close(con);
	...
	public void ReloadSpawnTable(String name) {
		...
		try {
			...
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error3", e);
		} catch (SecurityException e) {
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error4", e);
		} catch (ClassNotFoundException e) {
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error5", e);
		} finally {
			SQLUtil.close(rs);
			SQLUtil.close(pstm);
			SQLUtil.close(con);
	...
	public void storeSpawn(L1PcInstance pc, L1Npc npc) {
		...
		try {
			...
			_log.log(Level.SEVERE, "NpcSpawnTable[]Error6", e);
