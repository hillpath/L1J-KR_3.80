...
public class IceQueenController implements Runnable {
	private static Logger _log = Logger.getLogger(IceQueenController.class
			.getName());
	private static IceQueenController _instance;

	public static IceQueenController getInstance() {
		if (_instance == null) {
			_instance = new IceQueenController();
		}
		return _instance;
	}
	...
	public void run() {
		...
		while (true) {
			try {
				...
				if (End) {
					reset();
					L1World.getInstance().broadcastServerMessage("Ice Queen instance dungeons has been shut down.");
					L1World.getInstance().broadcastServerMessage("Waiting for the next entry.");
					break;
				} else if (FirstRoom) {
					First();
				} else if (SecondRoom) {
				...
				e.printStackTrace();
				_log.log(Level.SEVERE, "IceQueenController error occurred", e);
			} finally {
				try {
					Thread.sleep(1000);
				} catch (Exception e) {
	...
	private void SpawnMonster() {
		...
		for (int i = 0; i < 15; i++) {
			...
			L1SpawnUtil.spawn5(32765, 32818, (short) 2101, 6,
					_MonsterList[ran], 12, 1, 1);
		}
		L1SpawnUtil.spawn5(32749, 32800, (short) 2101, 6, _MonsterList[ran], 0,
				1, 1);
		L1SpawnUtil.spawn5(32749, 32817, (short) 2101, 6, _MonsterList[ran], 0,
				1, 1);
		L1SpawnUtil.spawn5(32766, 32833, (short) 2101, 6, _MonsterList[ran], 0,
				1, 1);
		...
		L1SpawnUtil.spawn5(32819, 32807, (short) 2101, 6,
				_MonsterList[CommonUtil.random(_MonsterList.length)], 0, 1, 2);
		L1SpawnUtil.spawn5(32819, 32805, (short) 2101, 6,
				_MonsterList[CommonUtil.random(_MonsterList.length)], 0, 1, 2);
		for (int i = 0; i < 15; i++) {
			ran = CommonUtil.random(_MonsterList.length);
			L1SpawnUtil.spawn5(32833, 32806, (short) 2101, 6,
		...
		L1SpawnUtil.spawn5(32857, 32831, (short) 2101, 6,
				_MonsterList[CommonUtil.random(_MonsterList.length)], 0, 1, 3);
		L1SpawnUtil.spawn5(32855, 32834, (short) 2101, 6,
				_MonsterList[CommonUtil.random(_MonsterList.length)], 0, 1, 3);
		for (int i = 0; i < 15; i++) {
			ran = CommonUtil.random(_MonsterList.length);
			L1SpawnUtil.spawn5(32850, 32853, (short) 2101, 6,
		...
		L1SpawnUtil.spawn5(32825, 32926, (short) 2101, 6, 46119, 0, 1, 5);
		L1SpawnUtil.spawn5(32819, 32926, (short) 2101, 6, 46120, 0, 1, 5);
		L1SpawnUtil.spawn5(32813, 32927, (short) 2101, 6, 46119, 0, 1, 5);
		L1SpawnUtil.spawn5(32814, 32917, (short) 2101, 6, 46120, 0, 1, 5);
		L1SpawnUtil.spawn5(32819, 32917, (short) 2101, 6, 46119, 0, 1, 5);
		L1SpawnUtil.spawn5(32826, 32914, (short) 2101, 6, 46120, 0, 1, 5);
	}
	...
	private void openDoor(int doorId) {
		...
		for (L1Object object : L1World.getInstance().getVisibleObjects(2101)
				.values()) {
